...
def merge_time_mono_to_full(path_mono_lab, path_full_lab):
...
def merge_phoneme_mono_to_full(path_mono_lab, path_full_lab):
...
def strings_are_different(s_old: str, s_new: str):
